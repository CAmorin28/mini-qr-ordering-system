...
import { MockPaymentDevControls } from "@/components/MockPaymentDevControls";
import { PaymentFailedPanel } from "@/components/PaymentFailedPanel";
import { PaymentProcessingOverlay } from "@/components/PaymentProcessingOverlay";
import { PaymentMethodIcon } from "@/components/PaymentMethodIcon";
import { useCart } from "@/context/CartContext";
import { emptyCustomer, useCheckout } from "@/context/CheckoutContext";
...
import { saveOrder, setPendingOrder } from "@/lib/client/order-history";
import {
  buildPlacedOrder,
  generateOrderId,
  placeOrderWithSimulation,
} from "@/lib/client/place-order";
import {
  CHECKOUT_PAGE_PATH,
  checkoutConfirmationPath,
  MENU_PAGE_PATH,
} from "@/lib/shared/menu-url";
import { formatTableLabel } from "@/lib/shared/table-session";
import { simulateMockPayment } from "@/lib/client/mock-payment";
