...
import { fetchGuestSessionStatus } from "@/lib/client/api-guest-session";
...
import { useTableVisitEndSync } from "@/hooks/useTableVisitEndSync";
import { useGuestSessionIdle } from "@/hooks/useGuestSessionIdle";
